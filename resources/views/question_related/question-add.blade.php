        ...
        <div class="flex justify-center">
            <x-auth-validation-errors class="mb-4" :errors="$errors" />
                ...
                <div class="w-full rounded-xl bg-white p-4 shadow-2xl shadow-white/40">
                    <div class="flex justify-center">
                        <form action="{{ route('question.store') }}" method="POST" class="w-full">
                            @csrf
                            ...
                            <div class="flex flex-col w-full mt-5">
                                ...
                                <textarea type="text" id="question" name="question"
                                    class="w-full rounded-lg border bg-gray-100 border-slate-200 px-2 py-1 hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/40 active:ring active:ring-blue-500/40"></textarea>
                            </div>
                            <div class="flex flex-col w-full mt-5">
                            ...
                            <div class="flex flex-col w-full mt-5">
                                ...
                                <div class="flex w-full rounded-lg border bg-gray-100 border-slate-200 px-2 py-3 justify-evenly">
                                    <div class=" hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/40 active:ring active:ring-blue-500/40">
                                        ...
                                        <input type="radio" class="form-radio" name="correct_answer" value="option1" checked />
